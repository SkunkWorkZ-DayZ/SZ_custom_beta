...
const string LOADING_SCREENS_PATH 	= "SZ_Custom_beta/Data/LoadingImages.json";
const string LOADING_MESSAGES_PATH 	= "SZ_Custom_beta/Data/LoadingMessages.json";
const string LOADING_SCREEN_LOGO 	= "SZ_Custom_beta/Pictures/loading_screen_logo_co.edds";
									//! ModName/Path/File
