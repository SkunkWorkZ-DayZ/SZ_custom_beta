...
class CfgPatches
{
    class SZ_Custom_beta_ExpansionMainMenuScenes
    {
        units[]={};
        weapons[]={};
        requiredVersion=0.1;
...
class cfgExpansionCharacterScenes
{
    ...
    {
        class SZ_Custom_beta_Scene // The name of your scene
        {
            ...
            MappingFiles[]=
            {
                "SZ_Custom_beta/MainMenuScenes/MyMapFile.map" // The path to your .map file, it allows you to load a custom mapping to your scene
            };
